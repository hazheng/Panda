...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="NonDriveDisplayPanel.ctl" Type="VI" URL="../util/NonDriveDisplayPanel.ctl"/>
			<Item Name="climber_outputs.ctl" Type="VI" URL="../../Robot/climber/climber_outputs.ctl"/>
			<Item Name="shooter_outputs.ctl" Type="VI" URL="../../Robot/Shooter/shooter_outputs.ctl"/>
			<Item Name="mecanum_output.ctl" Type="VI" URL="../../Robot/mecanum/mecanum_output.ctl"/>
			<Item Name="Outputs.ctl" Type="VI" URL="../../Robot/util/Outputs.ctl"/>
			<Item Name="climber_cmds.ctl" Type="VI" URL="../../Robot/climber/climber_cmds.ctl"/>
			<Item Name="shooter_cmds.ctl" Type="VI" URL="../../Robot/Shooter/shooter_cmds.ctl"/>
			<Item Name="mecanum_control.ctl" Type="VI" URL="../../Robot/mecanum/mecanum_control.ctl"/>
			<Item Name="Commands.ctl" Type="VI" URL="../../Robot/util/Commands.ctl"/>
			<Item Name="Dashboard.ctl" Type="VI" URL="../../Robot/util/Dashboard.ctl"/>
		</Item>
